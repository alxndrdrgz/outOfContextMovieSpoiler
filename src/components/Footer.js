      ...
      <footer>
        <div className="wrapper">
          ...
          <p className="api-attribution">
            This product uses the <span className="sr-only">TMDb API </span> 
            <a href="https://www.themoviedb.org/">
              <img className="tmdb-logo" src={tmdbLogo} alt="logo for The Movie Database" />
            </a> API but is not endorsed or certified by TMDB.
          </p>
